...
>
  ...
  <div className="relative mx-auto max-w-7xl px-4">
    ...
    <section className="py-16"><div className="mx-auto max-w-7xl px-4 grid lg:grid-cols-3 gap-10"><div className="lg:col-span-2"><h2 className="section-title text-3xl">Clubs</h2><p className="mt-4 text-gray-600 text-lg leading-8">Clubs

Students are encouraged to join clubs that match their interests and career aspirations. Available clubs include:

Debate Club, Science Club, Robotics Club, AI research and Programming Club, 9As Club, Entrepreneurship Club, Environmental Club, Scripture Union, Public Speaking Club<br></br><br></br>

These clubs help students develop leadership, communication, and problem-solving skills.
