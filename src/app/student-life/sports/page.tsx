...
>
  ...
  <div className="relative mx-auto max-w-7xl px-4">
    ...
    <section className="py-16"><div className="mx-auto max-w-7xl px-4 grid lg:grid-cols-3 gap-10"><div className="lg:col-span-2">
      ...
      <h2 className="section-title text-3xl">Sports</h2>
      <p className="mt-4 text-gray-600 text-lg leading-8">
MNB College promotes physical fitness and teamwork through a variety of sporting activities. Students participate in:
Soccer, Netball, Volleyball, Athletics, Basketball, Tennis, Indoor games<br></br><br></br>
Regular inter-house and inter-school competitions help learners develop discipline, confidence, and sportsmanship.</p>
