...
<section className="py-16"><div className="mx-auto max-w-7xl px-4 grid lg:grid-cols-3 gap-10"><div className="lg:col-span-2"><h2 className="section-title text-3xl">Vision</h2><p className="mt-4 text-gray-600 text-lg leading-8">To become a leading centre of educational excellence that develops innovative, disciplined, responsible, and globally competitive citizens.</p><br></br>
<h2 className="section-title text-3xl">Mission & Vision</h2>
<p className="mt-4 text-gray-600 text-lg leading-8">
To provide quality education through competent educators, modern technology, effective governance, and a nurturing environment that empowers learners to achieve their full potential academically, socially, and morally.</p>
