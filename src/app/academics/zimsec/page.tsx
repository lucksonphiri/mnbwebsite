...
>
  ...
  <div className="relative mx-auto max-w-7xl px-4">
    ...
    <section className="py-16"><div className="mx-auto max-w-7xl px-4 grid lg:grid-cols-3 gap-10"><div className="lg:col-span-2">
      ...
      <h2 className="section-title text-3xl">ZIMSEC</h2><p className="mt-4 text-gray-600 text-lg leading-8">As a registered ZIMSEC examination centre, MNB College prepares learners for national examinations through a structured and results-driven approach.

</p><br></br>
      

<h2 className="section-title text-3xl">Advantages</h2><p className="mt-4 text-gray-600 text-lg leading-8">

Proven examination strategies, Experienced examination teachers, Regular revision programmes, Consistently high pass rates

Our Commitment MNB College has maintained a strong academic record through dedicated teaching, learner support, and continuous monitoring of academic performance.</p>
