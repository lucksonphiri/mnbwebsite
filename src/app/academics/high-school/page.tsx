...
<h2 className="section-title text-3xl">High School</h2>
<p className="mt-4 text-gray-600 text-lg leading-8">Our High School programme caters for Forms 1 to 4 and provides a strong foundation for academic achievement.

Subjects Offered includes: Mathematics, English Language, Shona, Geography, History, Combined Science, Agriculture, Computer Science, Accounts, Building Enterprise Skills (BES)
</p><br></br>

<h2 className="section-title text-3xl">Benefits</h2>
<p className="mt-4 text-gray-600 text-lg leading-8">
Structured study programmes, Daily supervised prep sessions, Regular tests and assignments, Individual learner support
</p>



<div className="mt-8 grid md:grid-cols-2 gap-5"><div className="p-6 rounded-2xl bg-[var(--mnb-light)]"><h3 className="font-black text-[var(--mnb-navy)]">Key Information</h3><p className="text-gray-600 mt-2">This page is ready for official MNB College content, images and downloadable documents.</p></div><div className="p-6 rounded-2xl bg-[var(--mnb-light)]"><h3 className="font-black text-[var(--mnb-navy)]">Need Help?</h3><p className="text-gray-600 mt-2">Contact admissions or administration for further guidance.</p></div></div></div><aside className="bg-[var(--mnb-light)] rounded-3xl p-7 h-fit"><h3 className="font-black text-xl text-[var(--mnb-navy)]">Quick Links</h3><div className="grid gap-3 mt-5"><Link href="/admissions/apply-online" className="bg-white p-4 rounded-xl">Apply Online</Link><Link href="/downloads/prospectus" className="bg-white p-4 rounded-xl">Prospectus</Link><Link href="/contact" className="bg-white p-4 rounded-xl">Contact Us</Link></div></aside></div></section>
